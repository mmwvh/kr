...
goal(S) :- (on(blockA, loc1-1, S); on(blockA, loc1-2, S); on(blockA, loc1-3, S)), (on(blockB, loc1-1, S); on(blockB, loc1-2, S); on(blockB, loc1-3, S)), (on(blockC, loc1-1, S); on(blockC, loc1-2, S); on(blockC, loc1-3, S)).					% fill in the goal definition
